 ...
 */
public class KullaniciKisiselBilgilerEkran extends javax.swing.JFrame {

    KullaniciIslemleri kullaniciIslemleri = new KullaniciIslemleri();

    int mouseX, mouseY;

    public KullaniciKisiselBilgilerEkran() {
        initComponents();
    ...
    public void bilgileriGoruntule() {
        String no = String.valueOf(KullaniciIslemleri.girisYapanKullanici.getNo());
        ...
        String mailAdresi = KullaniciIslemleri.girisYapanKullanici.getMailAdresi();
        mailAdresiAlani.setText(mailAdresi);

        String ad = KullaniciIslemleri.girisYapanKullanici.getAd();
        adAlani.setText(ad);

        String soyad = KullaniciIslemleri.girisYapanKullanici.getSoyad();
    ...
    private void initComponents() {
        ...
        kullaniciNoYazisi.setToolTipText("Kullanıcı numaranız, otomasyona kayıt olduktan sonra sistem tarafından otomatik oluşturulur ve değiştirilemez.\n");
        ...
        mesajYazisi.setForeground(java.awt.Color.green);
        ...
        kullaniciNoAlani.setToolTipText("Kullanıcı numaranız, siz sisteme kayıt olduktan sonra otomatik olarak oluşturulur ve değiştirilemez.");
        ...
        formLayout.setHorizontalGroup(
            ...
            .addGroup(formLayout.createSequentialGroup()
                ...
                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(yataySeparator, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(formLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(formLayout.createSequentialGroup()
                ...
                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(formLayout.createSequentialGroup()
                        .addComponent(adresYazisi)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(jScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void guncelleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleButtonActionPerformed
        ...
        if (kullaniciAdi.equals("") || mailAdresi.equals("") || ad.equals("") || soyad.equals("") || adres.equals("")) {
            mesajYazisi.setText("Lütfen Bilgileri Eksiksiz Girdiğinizden Emin Olunuz!");
            mesajYazisi.setForeground(Color.RED);
        } else {
            kullaniciIslemleri.kisiselBilgilerGuncelle(no, kullaniciAdi, mailAdresi, ad, soyad, adres);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(KullaniciKisiselBilgilerEkran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new KullaniciKisiselBilgilerEkran().setVisible(true);
        });
    }
