 ...
 */
public class CalisanKisiselBilgilerEkran extends javax.swing.JFrame {

    CalisanIslemleri calisanIslemleri = new CalisanIslemleri();

    int mouseX, mouseY;

    public CalisanKisiselBilgilerEkran() {
        initComponents();
    ...
    public void bilgileriGoruntule() {
        String no = String.valueOf(CalisanIslemleri.girisYapanCalisan.getNo());
        calisanNoAlani.setText(no);

        String kullaniciAdi = CalisanIslemleri.girisYapanCalisan.getKullaniciAdi();
        kullaniciAdiAlani.setText(kullaniciAdi);

        String mailAdresi = CalisanIslemleri.girisYapanCalisan.getMailAdresi();
        mailAdresiAlani.setText(mailAdresi);

        String ad = CalisanIslemleri.girisYapanCalisan.getAd();
        adAlani.setText(ad);

        String soyad = CalisanIslemleri.girisYapanCalisan.getSoyad();
        soyadAlani.setText(soyad);

        String departman = CalisanIslemleri.girisYapanCalisan.getDepartman();
    ...
    private void initComponents() {
        ...
        mailAdresiYazisi.setToolTipText("Lütfen hâlihazırda kullandığınız bir mail adresini giriniz.");
        ...
        adYazisi.setText("Ad : ");
        adYazisi.setToolTipText("Ad bilginizi güvenlik sebebiyle değiştiremezsiniz.");
        ...
        soyadYazisi.setToolTipText("Soyad bilginizi güvenlik sebebiyle değiştiremezsiniz.");
        ...
        calisanNoYazisi.setToolTipText("Çalışan numaranız, yöneticiniz tarafından sisteme kayıt edildikten sonra otomatik olarak oluşturulur ve değiştirilemez.");
        ...
        departmanYazisi.setToolTipText("Departmanınız yöneticiniz tarafından belirlenir ve bu alanı değiştiremezsiniz.");
        ...
        calisanNoAlani.setToolTipText("Çalışan numaranız, yöneticiniz tarafından sisteme kayıt edildikten sonra otomatik olarak oluşturulur ve değiştirilemez.");
        ...
        mailAdresiAlani.setToolTipText("Lütfen hâlihazırda kullandığınız bir mail adresini giriniz.");
        ...
        adAlani.setToolTipText("Ad bilginizi güvenlik sebebiyle değiştiremezsiniz.");
        ...
        soyadAlani.setToolTipText("Soyad bilginizi güvenlik sebebiyle değiştiremezsiniz.");
        ...
        departmanAlani.setEditable(false);
        ...
        departmanAlani.setToolTipText("Departmanınız yöneticiniz tarafından belirlenir ve bu alanı değiştiremezsiniz.");
        ...
        formLayout.setHorizontalGroup(
            ...
            .addGroup(formLayout.createSequentialGroup()
                .addGap(12, 12, 12)
                .addComponent(yataySeparator, javax.swing.GroupLayout.PREFERRED_SIZE, 402, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(formLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(mesajYazisi, javax.swing.GroupLayout.PREFERRED_SIZE, 402, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        formLayout.setVerticalGroup(
            ...
            .addGroup(formLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(mesajYazisi, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void guncelleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleButtonActionPerformed
        ...
        if (kullaniciAdi.equals("") || mailAdresi.equals("")) {
            mesajYazisi.setText("Lütfen Bilgileri Eksiksiz Girdiğinizden Emin Olunuz!");
            mesajYazisi.setForeground(Color.RED);
        } else {
            calisanIslemleri.kisiselBilgilerGuncelle(no, kullaniciAdi, mailAdresi);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CalisanKisiselBilgilerEkran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new CalisanKisiselBilgilerEkran().setVisible(true);
        });
    }
